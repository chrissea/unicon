// ======================================================================
// PSoC_Unicon.v generated from TopDesign.cysch
// 02/01/2019 at 17:38
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d5be2c04-06cc-42ff-a11b-f8b50bbd9693/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DefSi=0, Direction=1, FifoSize=4, InterruptSource=1, Length=4, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, UseInputFifo=false, UseInterrupt=true, UseOutputFifo=false, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONFIG_TITLE=n64_one_bit, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=n64_one_bit, CY_INSTANCE_SHORT_NAME=n64_one_bit, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=n64_one_bit, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DefSi=0, Direction=1, FifoSize=4, InterruptSource=1, Length=4, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, UseInputFifo=false, UseInterrupt=true, UseOutputFifo=false, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONFIG_TITLE=n64_zero_bit, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=n64_zero_bit, CY_INSTANCE_SHORT_NAME=n64_zero_bit, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=n64_zero_bit, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DefSi=1, Direction=1, FifoSize=4, InterruptSource=1, Length=32, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, UseInputFifo=true, UseInterrupt=true, UseOutputFifo=false, UseShiftIn=false, UseShiftOut=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONFIG_TITLE=n64_ShiftReg_commack, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=n64_ShiftReg_commack, CY_INSTANCE_SHORT_NAME=n64_ShiftReg_commack, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=n64_ShiftReg_commack, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, DefSi=1, Direction=1, FifoSize=4, InterruptSource=1, Length=32, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, UseInputFifo=true, UseInterrupt=true, UseOutputFifo=false, UseShiftIn=false, UseShiftOut=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONFIG_TITLE=n64_ShiftReg_buttonstate, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=n64_ShiftReg_buttonstate, CY_INSTANCE_SHORT_NAME=n64_ShiftReg_buttonstate, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=n64_ShiftReg_buttonstate, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=528, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=528, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=1, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=count_time_to_transmit, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=count_time_to_transmit, CY_INSTANCE_SHORT_NAME=count_time_to_transmit, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=count_time_to_transmit, )
...
module top ;
    ...
    assign Net_1019 = cydff_7;
    // -- DFF End --

    // -- DFF Start --
    reg  cydff_6;
    always @(posedge n64_shift_clk)
    begin
        cydff_6 <= Net_1005;
    end
    assign Net_985 = cydff_6;
    // -- DFF End --

    // -- DFF Start --
    reg  cydff_5;
    always @(posedge n64_bit_clk)
    begin
        cydff_5 <= Net_1002;
    end
    assign Net_426 = cydff_5;
    // -- DFF End --
    ...
    assign Net_414 = cydff_4;
    // -- DFF End --

    // -- DFF Start --
    reg  cydff_15;
    always @(posedge start_rcv)
    begin
        cydff_15 <= Net_1388;
    end
    assign Net_1389 = cydff_15;
    // -- DFF End --
    ...
    // -- TFF Start --
    reg  cy_tff_2;
    always @(posedge Net_943)
    begin
        cy_tff_2 <= Net_944^start_msg;
    end
    assign start_msg = cy_tff_2;
    // -- TFF End --
    ...
    assign Net_943 = transmit_tc | Net_1213 | Net_221;
	...
	wire [0:0] tmpOE__From_ESP_net;
	wire [0:0] tmpIO_0__From_ESP_net;
	wire [0:0] tmpINTERRUPT_0__From_ESP_net;
	electrical [0:0] tmpSIOVREF__From_ESP_net;
	...
	cy_psoc3_pins_v1_10
		...
		From_ESP
		 (.oe(tmpOE__From_ESP_net),
		  .y({1'b0}),
		  .fb({Net_113}),
		  .io({tmpIO_0__From_ESP_net[0:0]}),
		  .siovref(tmpSIOVREF__From_ESP_net),
		  .interrupt({tmpINTERRUPT_0__From_ESP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__From_ESP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__To_ESP_net;
	wire [0:0] tmpFB_0__To_ESP_net;
	wire [0:0] tmpIO_0__To_ESP_net;
	wire [0:0] tmpINTERRUPT_0__To_ESP_net;
	electrical [0:0] tmpSIOVREF__To_ESP_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		To_ESP
		 (.oe(tmpOE__To_ESP_net),
		  .y({Net_108}),
		  .fb({tmpFB_0__To_ESP_net[0:0]}),
		  .io({tmpIO_0__To_ESP_net[0:0]}),
		  .siovref(tmpSIOVREF__To_ESP_net),
		  .interrupt({tmpINTERRUPT_0__To_ESP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__To_ESP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Console_2_net;
	wire [0:0] tmpFB_0__Console_2_net;
	wire [0:0] tmpINTERRUPT_0__Console_2_net;
	electrical [0:0] tmpSIOVREF__Console_2_net;

	cy_psoc3_pins_v1_10
		#(.id("6e1b7473-6e5e-47cd-b91b-99c26e2c4161"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Console_2
		 (.oe(tmpOE__Console_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Console_2_net[0:0]}),
		  .io({Net_152}),
		  .siovref(tmpSIOVREF__Console_2_net),
		  .interrupt({tmpINTERRUPT_0__Console_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Console_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    ShiftReg_v2_30_2 n64_one_bit (
        ...
        .shift_out(Net_989),
        .interrupt(Net_853));
    defparam n64_one_bit.Direction = 1;
    defparam n64_one_bit.FifoSize = 4;
    defparam n64_one_bit.Length = 4;
    ...
    assign Net_475 = cydff_8;
    // -- DFF End --

    ShiftReg_v2_30_3 n64_zero_bit (
        .shift_in(Net_1104),
        .load(1'b0),
        .store(1'b0),
        .clock(n64_shift_clk),
        ...
        .shift_out(Net_1104),
        .interrupt(Net_355));
    defparam n64_zero_bit.Direction = 1;
    defparam n64_zero_bit.FifoSize = 4;
    defparam n64_zero_bit.Length = 4;

    FreqDiv_v1_0 N64_Bit_Clock (
        .en(Net_1098),
        .div(n64_bit_clk),
        .reset(1'b0),
        .clock(n64_shift_clk));
    defparam N64_Bit_Clock.Divider = 4;
    defparam N64_Bit_Clock.highPulse = 2;
    defparam N64_Bit_Clock.numBits = 2;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_993 or Net_402 or Net_426)
        begin
            case (Net_426)
                1'b0 :  tmp__mux_1_reg = Net_993;
                1'b1 :  tmp__mux_1_reg = Net_402;
            endcase
        end
        assign Net_1005 = tmp__mux_1_reg;
    end
    // -- Mux end --


    assign Net_1032 = Net_1209 | Net_1199;

    ShiftReg_v2_30_4 n64_ShiftReg_commack (
        .shift_in(1'b0),
        .load(start_msg),
        .store(1'b0),
        .clock(n64_bit_clk),
        ...
        .shift_out(Net_1190),
        .interrupt(Net_221));
    defparam n64_ShiftReg_commack.Direction = 1;
    defparam n64_ShiftReg_commack.FifoSize = 4;
    defparam n64_ShiftReg_commack.Length = 32;
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_406 or Net_414 or switch_msg)
        begin
            case (switch_msg)
                1'b0 :  tmp__mux_2_reg = Net_406;
                1'b1 :  tmp__mux_2_reg = Net_414;
            endcase
        end
        assign Net_1002 = tmp__mux_2_reg;
    end
    // -- Mux end --
	...
	assign tmpOE__bufoe_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{n64_comm_state} : {n64_comm_state};

    ShiftReg_v2_30_5 n64_ShiftReg_buttonstate (
        .shift_in(1'b0),
        .load(start_msg),
        .store(1'b0),
        .clock(n64_bit_clk),
        ...
        .shift_out(Net_1001),
        .interrupt(Net_1213));
    defparam n64_ShiftReg_buttonstate.Direction = 1;
    defparam n64_ShiftReg_buttonstate.FifoSize = 4;
    defparam n64_ShiftReg_buttonstate.Length = 32;

    assign Net_1098 = 1'h1;
    ...
    assign Net_1436 = 1'h1;

    EdgeDetect_v1_0 detect_comm_state_1 (
        .d(n64_comm_state),
        .det(Net_1172),
        .clock(sys_clk));
    defparam detect_comm_state_1.EdgeType = 1;

    // -- DFF Start --
    reg  cydff_16;
    always @(posedge start_msg)
    begin
        cydff_16 <= Net_1436;
    end
    assign Net_1427 = cydff_16;
    // -- DFF End --
    ...
    assign Net_527 = cydff_9;
    // -- DFF End --

    Counter_v3_0_6 count_time_to_transmit (
        .reset(start_rcv),
        .tc(transmit_tc),
        .comp(Net_828),
        .clock(sys_clk),
        ...
        .up_ndown(1'b1),
        .count(1'b0));
    defparam count_time_to_transmit.CaptureMode = 0;
    defparam count_time_to_transmit.ClockMode = 3;
    defparam count_time_to_transmit.CompareMode = 0;
    defparam count_time_to_transmit.CompareStatusEdgeSense = 1;
    defparam count_time_to_transmit.EnableMode = 0;
    defparam count_time_to_transmit.ReloadOnCapture = 0;
    defparam count_time_to_transmit.ReloadOnCompare = 0;
    defparam count_time_to_transmit.ReloadOnOverUnder = 1;
    defparam count_time_to_transmit.ReloadOnReset = 1;
    defparam count_time_to_transmit.Resolution = 16;
    defparam count_time_to_transmit.RunMode = 1;
    defparam count_time_to_transmit.UseInterrupt = 1;

    // -- TFF Start --
    reg  cy_tff_3;
    always @(posedge n64_shift_clk)
    begin
        cy_tff_3 <= Net_1032^n64_comm_state;
    end
    assign n64_comm_state = cy_tff_3;
    // -- TFF End --
    ...
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_1386 or console_2_fb or Net_1019)
        begin
            case (Net_1019)
                1'b0 :  tmp__mux_4_reg = Net_1386;
                1'b1 :  tmp__mux_4_reg = console_2_fb;
            endcase
        end
        assign Net_1026 = tmp__mux_4_reg;
    end
    // -- Mux end --

    assign Net_1386 = 1'h1;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_527)
    begin
        cy_tff_1 <= Net_475^switch_msg;
    end
    assign switch_msg = cy_tff_1;
    // -- TFF End --


    assign Net_1246 = Net_1019 | start_msg;
    ...
    assign Net_1200 = cydff_11;
    // -- DFF End --


    assign Net_1174 = start_rcv | Net_1172;


    assign start_rcv = Net_1175 & Net_1176;

    // -- DFFE Start --
    reg  cy_dffe_2;
    always @(posedge sys_clk)
    begin
        cy_dffe_2 <= Net_1177 ? console_2_fb : cy_dffe_2;
    end
    assign Net_1175 = cy_dffe_2;
    // -- DFFE End --


    assign Net_1176 = ~console_2_fb;

    // -- TFF Start --
    reg  cy_tff_5;
    always @(posedge sys_clk)
    begin
        cy_tff_5 <= Net_1174^Net_1177;
    end
    assign Net_1177 = cy_tff_5;
    // -- TFF End --

    assign Net_1388 = 1'h1;


    assign Net_1395 = ~n64_comm_state;

    assign Net_1390 = 1'h0;
