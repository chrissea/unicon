...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DefSi=0, Direction=1, FifoSize=4, InterruptSource=0, Length=8, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, UseInputFifo=true, UseInterrupt=false, UseOutputFifo=true, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONFIG_TITLE=ShiftReg_fwd, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ShiftReg_fwd, CY_INSTANCE_SHORT_NAME=ShiftReg_fwd, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ShiftReg_fwd, )
...
// ShiftReg_v2_30(ControlRegUsageReplacemetString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DefSi=0, Direction=1, FifoSize=4, InterruptSource=0, Length=8, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, UseInputFifo=true, UseInterrupt=false, UseOutputFifo=true, UseShiftIn=true, UseShiftOut=true, VerilogSectionReplacementString=sC8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ShiftReg_v2_30, CY_CONFIG_TITLE=ShiftReg_rev, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ShiftReg_rev, CY_INSTANCE_SHORT_NAME=ShiftReg_rev, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ShiftReg_rev, )
...
module top ;
	...
	wire [0:0] tmpOE__Controller_1_net;
	wire [0:0] tmpFB_0__Controller_1_net;
	wire [0:0] tmpINTERRUPT_0__Controller_1_net;
	electrical [0:0] tmpSIOVREF__Controller_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Controller_1
		 (.oe(tmpOE__Controller_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Controller_1_net[0:0]}),
		  .io({Net_56}),
		  .siovref(tmpSIOVREF__Controller_1_net),
		  .interrupt({tmpINTERRUPT_0__Controller_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Controller_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ShiftReg_v2_30_0 ShiftReg_fwd (
        .shift_in(Net_67),
        .load(Net_20),
        .store(Net_20),
        .clock(shift_clk),
        ...
        .shift_out(Net_24),
        .interrupt(Net_25));
    defparam ShiftReg_fwd.Direction = 1;
    defparam ShiftReg_fwd.FifoSize = 4;
    defparam ShiftReg_fwd.Length = 8;

	wire [0:0] tmpOE__Console_1_net;
	wire [0:0] tmpFB_0__Console_1_net;
	wire [0:0] tmpINTERRUPT_0__Console_1_net;
	electrical [0:0] tmpSIOVREF__Console_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Console_1
		 (.oe(tmpOE__Console_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Console_1_net[0:0]}),
		  .io({Net_37}),
		  .siovref(tmpSIOVREF__Console_1_net),
		  .interrupt({tmpINTERRUPT_0__Console_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Console_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    FreqDiv_v1_0 FreqDiv_fwd (
        .en(Net_30),
        .div(Net_20),
        .reset(1'b0),
        .clock(shift_clk));
    defparam FreqDiv_fwd.Divider = 32;
    defparam FreqDiv_fwd.highPulse = 16;
    defparam FreqDiv_fwd.numBits = 5;
	...
	assign tmpOE__bufoe_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_82} : {Net_82};

    ShiftReg_v2_30_1 ShiftReg_rev (
        .shift_in(Net_41),
        .load(Net_43),
        .store(Net_43),
        .clock(shift_clk),
        ...
        .shift_out(Net_46),
        .interrupt(Net_47));
    defparam ShiftReg_rev.Direction = 1;
    defparam ShiftReg_rev.FifoSize = 4;
    defparam ShiftReg_rev.Length = 8;

    FreqDiv_v1_0 FreqDiv_rev (
        .en(1'b1),
        .div(Net_43),
        .reset(1'b0),
        .clock(shift_clk));
    defparam FreqDiv_rev.Divider = 32;
    defparam FreqDiv_rev.highPulse = 16;
    defparam FreqDiv_rev.numBits = 5;
	...
	assign tmpOE__bufoe_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{comm_state} : {comm_state};
	...
	wire [0:0] tmpOE__Communication_State_net;
	wire [0:0] tmpIO_0__Communication_State_net;
	wire [0:0] tmpINTERRUPT_0__Communication_State_net;
	electrical [0:0] tmpSIOVREF__Communication_State_net;

	cy_psoc3_pins_v1_10
		#(.id("212a7282-1522-448a-89f2-23dc09ad8b83"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Communication_State
		 (.oe(tmpOE__Communication_State_net),
		  .y({1'b0}),
		  .fb({comm_state}),
		  .io({tmpIO_0__Communication_State_net[0:0]}),
		  .siovref(tmpSIOVREF__Communication_State_net),
		  .interrupt({tmpINTERRUPT_0__Communication_State_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Communication_State_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_82 = ~comm_state;
