...
uint8 ShiftReg_fwd_initVar = 0u;


/*******************************************************************************
* Function Name: ShiftReg_fwd_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  ShiftReg_fwd_initVar - used to check initial configuration, modified on
*  first function call.
*
* Reentrant:
*  No.
...
{
    if(0u == ShiftReg_fwd_initVar)
    {
        ShiftReg_fwd_Init();
        ShiftReg_fwd_initVar = 1u; /* Component initialized */
    }
...
/*******************************************************************************
* Function Name: ShiftReg_fwd_Enable
********************************************************************************
*
* Summary:
...
void ShiftReg_fwd_Enable(void) 
{
    ...
    ShiftReg_fwd_SR_CONTROL |= ShiftReg_fwd_CLK_EN;

    ShiftReg_fwd_EnableInt();
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_Init
********************************************************************************
*
* Summary:
...
{
    ShiftReg_fwd_SetIntMode(ShiftReg_fwd_INT_SRC);
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_Stop
********************************************************************************
*
* Summary:
...
void ShiftReg_fwd_Stop(void) 
{
    ...
    ShiftReg_fwd_SR_CONTROL &= ((uint8) ~ShiftReg_fwd_CLK_EN);
    ShiftReg_fwd_DisableInt();
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_EnableInt
********************************************************************************
*
* Summary:
...
void ShiftReg_fwd_EnableInt(void) 
{
    ...
    ShiftReg_fwd_SR_AUX_CONTROL |= ShiftReg_fwd_INTERRUPTS_ENABLE;
    CyExitCriticalSection(interruptState);
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_DisableInt
********************************************************************************
*
* Summary:
...
void ShiftReg_fwd_DisableInt(void) 
{
    ...
    interruptState = CyEnterCriticalSection();
    ShiftReg_fwd_SR_AUX_CONTROL &= ((uint8) ~ShiftReg_fwd_INTERRUPTS_ENABLE);
    CyExitCriticalSection(interruptState);
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_GetFIFOStatus
********************************************************************************
*
* Summary:
...
uint8 ShiftReg_fwd_GetFIFOStatus(uint8 fifoId) 
{
    ...
    result = ShiftReg_fwd_RET_FIFO_NOT_DEFINED;

    #if(0u != ShiftReg_fwd_USE_INPUT_FIFO)
        if(ShiftReg_fwd_IN_FIFO == fifoId)
        {
            switch(ShiftReg_fwd_GET_IN_FIFO_STS)
            {
                case ShiftReg_fwd_IN_FIFO_FULL :
                    result = ShiftReg_fwd_RET_FIFO_FULL;
                    break;

                case ShiftReg_fwd_IN_FIFO_EMPTY :
                    result = ShiftReg_fwd_RET_FIFO_EMPTY;
                    break;

                case ShiftReg_fwd_IN_FIFO_PARTIAL:
                    result = ShiftReg_fwd_RET_FIFO_PARTIAL;
                    break;
    ...
    if(ShiftReg_fwd_OUT_FIFO == fifoId)
    {
        switch(ShiftReg_fwd_GET_OUT_FIFO_STS)
        {
            case ShiftReg_fwd_OUT_FIFO_FULL :
                result = ShiftReg_fwd_RET_FIFO_FULL;
                break;

            case ShiftReg_fwd_OUT_FIFO_EMPTY :
                result = ShiftReg_fwd_RET_FIFO_EMPTY;
                break;

            case ShiftReg_fwd_OUT_FIFO_PARTIAL :
                result = ShiftReg_fwd_RET_FIFO_PARTIAL;
                break;
...
/*******************************************************************************
* Function Name: ShiftReg_fwd_SetIntMode
********************************************************************************
*
* Summary:
...
{
    ShiftReg_fwd_SR_STATUS_MASK &= ((uint8) ~ShiftReg_fwd_INTS_EN_MASK);          /* Clear existing int */
    ShiftReg_fwd_SR_STATUS_MASK |= (interruptSource & ShiftReg_fwd_INTS_EN_MASK); /* Set int */
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_GetIntStatus
********************************************************************************
*
* Summary:
...
{
    return(ShiftReg_fwd_SR_STATUS & ShiftReg_fwd_INTS_EN_MASK);
}


/*******************************************************************************
* Function Name: ShiftReg_fwd_WriteRegValue
********************************************************************************
*
* Summary:
                                                                     ...
                                                                     
{
...
#if(0u != ShiftReg_fwd_USE_INPUT_FIFO)
    /*******************************************************************************
    * Function Name: ShiftReg_fwd_WriteData
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ShiftReg_fwd_ReadData
    ********************************************************************************
    *
    * Summary:
...
/*******************************************************************************
* Function Name: ShiftReg_fwd_ReadRegValue
********************************************************************************
*
* Summary:
