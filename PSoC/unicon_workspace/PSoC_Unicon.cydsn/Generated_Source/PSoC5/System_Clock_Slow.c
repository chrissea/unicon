...
/*******************************************************************************
* Function Name: System_Clock_Slow_Start
********************************************************************************
*
* Summary:
...
void System_Clock_Slow_Start(void) 
{
    ...
    System_Clock_Slow_CLKEN |= System_Clock_Slow_CLKEN_MASK;
	System_Clock_Slow_CLKSTBY |= System_Clock_Slow_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: System_Clock_Slow_Stop
********************************************************************************
*
* Summary:
...
void System_Clock_Slow_Stop(void) 
{
    ...
    System_Clock_Slow_CLKEN &= (uint8)(~System_Clock_Slow_CLKEN_MASK);
	System_Clock_Slow_CLKSTBY &= (uint8)(~System_Clock_Slow_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: System_Clock_Slow_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((System_Clock_Slow_CLKEN & System_Clock_Slow_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = System_Clock_Slow_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = System_Clock_Slow_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* System_Clock_Slow__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(System_Clock_Slow_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(System_Clock_Slow_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: System_Clock_Slow_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: System_Clock_Slow_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = System_Clock_Slow_GetSourceRegister();
    uint16 oldDivider = System_Clock_Slow_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = System_Clock_Slow_CLKEN & System_Clock_Slow_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(System_Clock_Slow_DIV_PTR, clkDivider);
                System_Clock_Slow_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                System_Clock_Slow_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(System_Clock_Slow_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((System_Clock_Slow_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(System_Clock_Slow_DIV_PTR, clkDivider);
				System_Clock_Slow_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: System_Clock_Slow_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(System_Clock_Slow_DIV_PTR);
}


/*******************************************************************************
* Function Name: System_Clock_Slow_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    System_Clock_Slow_MOD_SRC |= modeBitMask & (uint8)System_Clock_Slow_MODE_MASK;
}


/*******************************************************************************
* Function Name: System_Clock_Slow_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    System_Clock_Slow_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(System_Clock_Slow_MODE_MASK));
}


/*******************************************************************************
* Function Name: System_Clock_Slow_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return System_Clock_Slow_MOD_SRC & (uint8)(System_Clock_Slow_MODE_MASK);
}


/*******************************************************************************
* Function Name: System_Clock_Slow_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = System_Clock_Slow_GetDividerRegister();
    uint8 oldSrc = System_Clock_Slow_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        System_Clock_Slow_MOD_SRC |= CYCLK_SSS;
        System_Clock_Slow_MOD_SRC =
            (System_Clock_Slow_MOD_SRC & (uint8)(~System_Clock_Slow_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: System_Clock_Slow_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return System_Clock_Slow_MOD_SRC & System_Clock_Slow_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: System_Clock_Slow_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    System_Clock_Slow_PHASE = clkPhase & System_Clock_Slow_PHASE_MASK;
}


/*******************************************************************************
* Function Name: System_Clock_Slow_GetPhase
********************************************************************************
*
* Summary:
...
{
    return System_Clock_Slow_PHASE & System_Clock_Slow_PHASE_MASK;
}
